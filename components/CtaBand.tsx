    ...
    <section className="bg-charcoal border-y border-white/10 py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6 md:px-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        ...
        <div className="shrink-0 flex flex-wrap gap-3">
          <a
            href={`tel:${PHONE_TEL}`}
            className="font-display uppercase tracking-wider text-sm md:text-base bg-white hover:bg-steel-silver text-charcoal px-7 py-4 rounded-[1px] transition-colors"
          >
            Call {PHONE_DISPLAY}
          </a>
          <Link
