...
export default function PageHeader({
  ...
  return (
    <section className="relative pt-48 pb-16 md:pt-56 md:pb-20 bg-gunmetal border-b border-white/10 overflow-hidden">
      {image && (
        <>
          <Image
            src={image}
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <p className="spec-tick font-utility text-xs tracking-[0.25em] uppercase text-ember-bright mb-4">
          {eyebrow}
        </p>
